...
def writeToCsv(data, filename, part):
    ...
    xlsxPath = os.path.join("excel", "single-view", "train-val-test", part, "xlsx")
    csvPath = os.path.join("excel", "single-view", "train-val-test", part, "csv")
...
if __name__ == "__main__":
    ...
    source_dir = r'data-train-val-test'
